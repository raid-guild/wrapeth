    ...
    setupNotifier() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.notifier = new Notifier_1.default({
                networkId: this.authereum.getConfig().networkId,
                disableNotifications: this.authereum.getConfig().disableNotifications
            });
            const style = document.createElement('style');
            style.rel = 'stylesheet';
            style.type = 'text/css';
            style.textContent = css_1.default;
            style.innerText = css_1.default;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const walletSubprovider = new hooked_wallet_1.default({
                ...
                approveTransaction: (txParams, cb) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    txParams.data = utils_1.normalizeHex(txParams.data, { evenLength: true, addPrefix: true });
                    if (cb) {
                        cb(null, true);
                    }
                    return true;
            ...
            this._processTransaction = (txParams, cb) => __awaiter(this, void 0, void 0, function* () {
                try {
                    const didApprove = yield walletSubprovider.approveTransaction(txParams);
                    yield pify_1.default(walletSubprovider.checkApproval)('transaction', didApprove);
                    txParams = yield pify_1.default(walletSubprovider.fillInTxExtras.bind(walletSubprovider))(txParams);
            ...
            this._signMessage = (msgParams, cb) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    let authKeySig = yield this.authereum.getLoginKeyAuthSignature();
                    let loginKeyRestrictionData = yield this.authereum.getLoginKeyRestrictionData();
                    // Combines three hex strings into one hex string
                    authKeySig = authKeySig.slice(2);
                    loginKeyRestrictionData = loginKeyRestrictionData.slice(2);
                    const combinedSig = sig.concat(authKeySig, loginKeyRestrictionData);
                    this.notifier.notify('success', `Signed message "${msgParams.data}"`, { timeout: 2000 });
                    if (cb) {
                        cb(null, combinedSig);
                    }
                    return combinedSig;
            ...
            this._signTypedMessage = (msgParams, cb) => __awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    this.notifier.notify('success', 'Signed message', { timeout: 2000 });
                    if (cb) {
                        cb(null, combinedSig);
                    }
                    return combinedSig;
            ...
            this._signTransaction = (txParams, cb) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (web3Utils.toHex(txParams.gas) === '0x5208') {
                    txParams.gas = web3Utils.toHex(500000);
                }
                walletSubprovider.fillInTxExtras(txParams, (err, txWithExtras) => __awaiter(this, void 0, void 0, function* () {
                    if (err) {
                        if (cb) {
                            cb(err);
                            return;
                    ...
                    txWithExtras.gas = utils_1.normalizeHex(txWithExtras.gas);
                    txWithExtras.gasPrice = utils_1.normalizeHex(txWithExtras.gasPrice);
                    txWithExtras.value = utils_1.normalizeHex(txWithExtras.value);
                    txWithExtras.data = utils_1.normalizeHex(txWithExtras.data);
                    try {
                        const res = yield this.authereum.signTransactionWithLoginKey(txWithExtras);
                        if (!res) {
                            if (cb) {
                                // NOTE: Nothing should be done here. A notification will appear from the backend/
                                // NOTE: Throwing an error here will crash the dapp.
                            }
                            return;
                        }
                        if (cb) {
            ...
            // Replace updated rpc url if config is updated.
            // Only required for browser extension.
            // TODO: improve to not use interval
            // setInterval(() => {
            // this.rpcSubProvider.rpcUrl = this.authereum.getRpcUri()
            // }, 5e3)
